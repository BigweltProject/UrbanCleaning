                                                      ...
                                                      decoration: BoxDecoration(
                                                          ...
                                                          image: DecorationImage(
                                                              ...
                                                              image: products1[index].img != null
                                                                  ? NetworkImage(Constant.Product_Imageurl1 + products1[index].img)
                                                                      ...
                                                                      children: <Widget>[
                                                                        GestureDetector(
                                                                          onTap: () {
                                                                            ...
                                                                            if (products1[index].counts != "0" &&
                                                                                int.parse(products1[index].counts) > 0) {
                                                                              setState(() {
                                                                                print("products1[index].counts");
                                                                                print(products1[index].counts);
...
//
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child: Center(
                                                                            child: Text(
                                                                                products1[index].counts != null ? '${products1[index].counts}' : '0',
                                                                                style: TextStyle(
                                                                                    color: Colors.black,
                                                                                    fontSize: 19,
                                                                                    fontFamily: 'Roboto',
                                                                        ...
                                                                        GestureDetector(
                                                                          onTap: () {
                                                                            if (int.parse(products1[index].counts) <=
...
//                                                                                _count++;
                                                                                ...
                                                                                if (products1[index].moq == "1") {
                                                                                  ...
                                                                                  int totalquantity = int.parse(quantity == "1" ? "0" : quantity) +
...
//
                            ...
                            : Container(margin: EdgeInsets.only(top: 160), child: Center(child: CircularProgressIndicator()))
                        : Container(margin: EdgeInsets.only(top: 160), child: Center(child: Text("No service is avaliable"))),
                    SizedBox(
                      height: 80,
                    ),
                  ],
  ...
  showAlertDialog(BuildContext context, int index) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
          "Your cart contains services from different Category. Do you want to discard the selection and add this" + products1[index].productName),
      actions: [
        cancelButton,
        continueButton,
      ],
