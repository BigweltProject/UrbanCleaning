...
//        print(user.name);
  ...
  Future _AddAddress() async {
    ...
    map['lat'] = pre.getString("lat").substring(0, 10) != null
        ? pre.getString("lat").substring(0, 10)
        : Constant.latitude.toString();
    map['lng'] = pre.getString("lng").substring(0, 10) != null
