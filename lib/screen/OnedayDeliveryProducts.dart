                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Text('${Constant.carditemCount}',
                            style: TextStyle(color: AppColors.tela, fontSize: 15.0)),
                      ),
                    ),
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              Padding(
                                                ...
                                                child: Text('${products1[index].moq } kg', style: TextStyle(
                                                  color: AppColors.mrp,
...
//
                                                        ...
                                                        Padding(
                                                          ...
                                                          child:Center(
                                                            child:
                                                            Text(products1[index].count!=null?products1[index].count=="1"?"0":'${products1[index].count}':'$_count',
...
//                                                                                _count++;
                                  ...
                                  products1[index].count=="1"|| products1[index].count=="0"? Container():  Container(
                                    // height: 30,
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Padding(
                                          padding: const EdgeInsets.only(top: 2.0, bottom: 1),
                                          child: Text('\u{20B9} ${int.parse(calDiscount(products1[index].buyPrice,products1[index].discount))*int.parse((products1[index].count))}', style: TextStyle(
                                            color: AppColors.sellp,
                                            fontWeight: FontWeight.w700,
                                          )),
                                        ),
                                                    ...
                                                    onTap: () {
                                                      if(Constant.isLogin){
                                                        ...
                                                        _addToproducts(products1[index].productIs,products1[index].productName,products1[index].img,int.parse(mrp_price),int.parse(products1[index].count),color,size,products1[index].productDescription,gst_sgst,gst_cgst,
                                                            products1[index].discount,dicountValue.toString(), products1[index].APMC, admindiscountprice.toString(),products1[index].buyPrice,products1[index].shipping,products1[index].quantityInStock,products1[index].youtube,products1[index].mv,products1[index].moq);
...
//cost_price=buyprice
  void _addToproducts(String pID,String p_name,String image,int price, int quantity,String c_val,String p_size,String p_disc,String sgst,String cgst,String discount,
      String dis_val,String adminper, String adminper_val,String cost_price,String shippingcharge,String  totalQun,String varient,String mv, String moq) {
try {
  if (products2 == null) {
//      print(pID+"......");
//      print(p_name);
...
//      print(cost_price);
    Future<int> val;
    int value;
    ProductsCart st = new ProductsCart(pid: pID,
        pname: p_name,
        pimage: image,
