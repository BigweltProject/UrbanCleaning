...
class UserVenderSerchState extends State<UserVenderSerch> {
  ...
  void initState() {
    ...
    searchvender("", Constant.rad).then((usersFromServe) {
      if (this.mounted) {
        setState(() {
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: TextField(
                    onChanged: (string) {
                      if (string != null) {
                        searchvender(string, Constant.rad).then((usersFromServe) {
                          setState(() {
                            users = usersFromServe;
                            if (users != null) {
                              suggestionList = users;
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text(
              "Select distance ${Constant.rad} km ",
              style: TextStyle(fontSize: 17),
            ),
          ),
          Slider(
            value: double.parse(Constant.rad),
            min: 10,
            max: 200,
            divisions: 20,
            ...
            onChanged: (double value) {
              setState(() {
                ...
                distance = value;
                Constant.rad = _currentSliderValue.toStringAsFixed(2).toString();
                                              ...
                                              image: DecorationImage(
                                                  ...
                                                  image: suggestionList[index].pp != null
                                                      ? suggestionList[index].pp == "no-pp.png"
                                                          ...
                                                          : NetworkImage(Constant.logo_Image_mv + suggestionList[index].pp)
                                                      : AssetImage("assets/images/plogo.png"))),
                                        ),
                                        Expanded(
                                          child: Container(
