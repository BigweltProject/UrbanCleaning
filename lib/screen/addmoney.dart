...
import 'package:maxeyfresh/screen/transactionsuccess.dart';
...
/*     var options = {
  ...
  Future _getInvoice1(String paymode) async {
    ...
    final response =
        await http.post(Constant.base_url + 'api/order.php', body: map);
...
//    print("123  Unable to generate Employee Invoice");
  ...
  Future _uploadProducts(String invoice, String paytype) async {
    ...
    for (int i = 1; i < 2; i++) {
      ...
      final response = await http
          .post(Constant.base_url + 'api/order.php', body: map);
  ...
  Future _afterPayment(
    ...
    print("mymap---->${map}");
    final response = await http
        .post(Constant.base_url + 'verifyUserWallet.php', body: map);
    try {
