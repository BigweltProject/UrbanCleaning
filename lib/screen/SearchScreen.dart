...
class UserFilterDemoState extends State<UserFilterDemo> {
  ...
  List<Categary> users = List();
  List<Categary> suggestionList = List();
  ...
  void initState() {
    ...
    searchval1("", "").then((usersFromServe) {
      setState(() {
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    child: TextField(
                      onChanged: (string) {
                        if (string != null) {
                          searchval1(string, "").then((usersFromServe) {
                            setState(() {
                              users = usersFromServe;
                              if (users != null) {
                                suggestionList = users;
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => ProductList(
                                        suggestionList[index].pcatId,
                                        suggestionList[index].pCats)),
                              );
