...
import 'package:maxeyfresh/model/ordershow.dart';
import 'package:maxeyfresh/screen/addmoney.dart';
...
class _WalltReportState extends State<WalltReport> {
  ...
  init() async {
    await mywallet(Constant.user_id).then((usersFromServe) {
      if (this.mounted) {
        setState(() {
            ...
            content: Column(
              ...
              children: [
                ...
                Text("Note: ${entry.wNote}",
                    ...
                    style:
                        TextStyle(fontSize: 15, color: AppColors.darkGray)),
                SizedBox(height: 6),
