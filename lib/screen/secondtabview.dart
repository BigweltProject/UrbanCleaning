...
class _ScreenState extends State<Screen2> {
  ...
  final List<String> imgList1 = [
    ...
    'https://assets.myntassets.com/h_440,q_90,w_680/v1/assets/images/10652398/2019/10/16/e95befb9-8fe0-48b4-89d5-521b5d1f98c71571221021545-The-Chennai-Silks---Pure-Kanjivaram-Silk-Saree-3611571221020-1.jpg',  'https://assets.myntassets.com/f_webp,dpr_2.0,q_60,w_210,c_limit,fl_progressive/assets/images/6563444/2018/5/29/61a73b47-70b1-4eb1-ab4a-fad963f2a23e1527587516269-NA-3021527587515007-1.jpg',
            ...
            children: <Widget>[
              Center(
                child: Padding(
                  ...
                  child: Text(widget.title.isEmpty?"Products":widget.title,style: TextStyle(color: AppColors.white,fontSize: 15),),
                ),
              ),
                                ...
                                children: <Widget>[
                                  SizedBox(
                                    ...
                                    child: CachedNetworkImage(
                                      fit: BoxFit.cover,
                                      imageUrl:Constant.Base_Imageurl+snapshot.data[index].img,
                                  ...
                                  Padding(
                                    ...
                                    child: ListTile(
                                      title: Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 11,color:Colors.teal[200],   fontWeight: FontWeight.bold,
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                child: Text('(\u{20B9} ${snapshot.data[index].buyPrice})',
                                                  overflow:TextOverflow.ellipsis,
                                                  maxLines: 2,
                                                  style: TextStyle(
                                                      fontWeight: FontWeight.w700,
