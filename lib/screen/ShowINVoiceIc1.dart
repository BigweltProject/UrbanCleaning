...
//                                    borderRadius: BorderRadius.(10.0),
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text("Phone Pe :", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.black),),
                                  ),
                                  Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child: Text("8105222216", style: TextStyle(fontSize: 20,color: Colors.black),),
                                  ),
                                ],
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child: Text("Google Pay :", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.black),),
                                  ),
                                  Padding(
                                    padding: EdgeInsets.all(5.0),
                                    child: Text("8105222216", style: TextStyle(fontSize: 20,color: Colors.black),),
