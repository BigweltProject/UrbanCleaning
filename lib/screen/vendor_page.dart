                    ...
                    widget.plist.img.length > 0
                        ? Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                Constant.Product_Imageurl + widget.plist.img,
                                width: MediaQuery.of(context).size.width / 3 + 10,
                                height: 180,
                                fit: BoxFit.fill,
                              ),
            ...
            onValueSelected: (date1) {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  width: 345,
                  decoration:
                      BoxDecoration(borderRadius: BorderRadius.circular(60), border: Border.all(color: AppColors.tela), color: AppColors.tela),
                  child: TextButton(
