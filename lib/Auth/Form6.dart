...
import 'package:maxeyfresh/Auth/widgets/custom_shape.dart';
import 'package:maxeyfresh/Auth/widgets/customappbar.dart';
import 'package:maxeyfresh/Auth/widgets/responsive_ui.dart';
...
//
                            ...
                            _getEmployee():showLongToast("Please enter the name");
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text("Enter the code send to", style: TextStyle(
                                fontSize: 18.0),),
                          ),
                          ...
                          Padding(
                            ...
                            child: Text(
                              updatephoneControler.text!=null? updatephoneControler.text:" ",
                              style: TextStyle(
                                  fontSize: 18.0, fontWeight: FontWeight.normal,color: AppColors.tela),
                            ),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  left: 5.0, top: 18.0, right: 0.0,bottom: 0),
                              child: Text(
                                "RESEND",
                                style: TextStyle(
                                    fontSize: 13.0, fontWeight: FontWeight.normal,color: Colors.green),
                              ),
                            ),
                          ),
                        ],
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                              onTap: (){
                               ...
                               }else {showLongToast("Please Enter  the otp!");
                               setState(() {
                                 flag1 = false;
                               });
...
print(updatephoneControler.text);
    ...
    final response = await http.post(Constant.base_url+'api/step1.php',body:map);
...
print(currentText);
    ...
    map['otp']=currentText;
    map['mobile']= updatephoneControler.text;
    final response = await http.post(Constant.base_url+'api/step2.php',body:map);
    if (response.statusCode == 200) {
  ...
  Future _getEmploye() async {
    ...
    final response = await http.post(Constant.base_url+'api/step3.php',body:map);
    if (response.statusCode == 200) {
      final jsonBody = json.decode(response.body);
...
*/
  ...
  Widget getTitle1(String title){
    return Padding(
      padding: EdgeInsets.only(left: 20,top: 10),
      child: Text(title,style: TextStyle(fontSize: 15,fontWeight:FontWeight.bold,color: Colors.white),),
    );
  }
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [AppColors.tela, AppColors.tela],
                ),
              ),
            ),
          ),
