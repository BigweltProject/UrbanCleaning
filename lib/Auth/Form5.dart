...
class _MyMapState extends State<MyMap1> {
  ...
  String  shopname,shopcat,username,email,mobile,shopadd,locality,city,state,pincode,permanentadd,password,cont_persionname,franchise,user_id,
      documenttype,documentnumber,docimage,pan_number,panImage,firmnumber,firmImage,gstnumber,gstImage;
...
//         ),
  ...
  Widget _getActionButtons() {
   ...
   Future updatelocation(double latitude,double longitide ) async {
    ...
    print(latitude);
    print(longitide);
    String link = Constant.base_url + "api/cp.php?shop_id=" + shop_id + "&lat=" + latitude.toString() + "&lng=" + longitide.toString();
