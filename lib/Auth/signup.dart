...
import 'package:maxeyfresh/Auth/Form5.dart';
...
import 'package:maxeyfresh/Auth/widgets/textformfield.dart';
...
//        pref.setString("mobile",phoneController.text);
  ...
  void gatinfo() async {
    ...
    setState(() {
      ...
      add!=null?SHOPADDRESSController.text=add:SHOPADDRESSController.text=valArea;
      pinval=pin!=null?pin:"";
      cityController.text=city!=null?city:"";
      Constant.latitude=double.parse(lat);
      Constant.longitude=double.parse(lng);
    });
  }
...
//                                      icon: new Icon(Icons.queue_play_next),
  ...
  Widget lastNameTextFormField() {
    return Container(
      child: InkWell(
        onTap: (){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MyMap1()),);
          ...
          child: Row(
            ...
            children: [
              Padding(
                ...
                child: Icon(Icons.location_on_outlined,size: 30, color: AppColors.boxColor1),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("Use Current Location",style:TextStyle(fontSize: 20,color: AppColors.black,fontWeight: FontWeight.bold),),
                    ),
                    Padding(
                      padding: EdgeInsets.only(bottom: 10,left: 3,right: 3,),
                      child: Text("Add New Address  ",style:TextStyle(fontSize: 15,color: AppColors.black,),),
                    ),
              ...
              Padding(
                padding: EdgeInsets.all(5),
                child: Icon(Icons.forward,size: 30, color: AppColors.boxColor1),
              ),
