...
import 'package:maxeyfresh/Auth/widgets/CustomeAppBar1.dart';
...
import 'package:maxeyfresh/model/LoginModal.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future _getEmployee() async {
    ...
    if (nameController.text == '7204802625') {
      ...
      final response =
          await http.post(Constant.base_url + 'api/login.php', body: map);
...
//              .showSnackBar(SnackBar(content: Text('Login Successful')));
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: <Color>[AppColors.tela, AppColors.tela],
          ),
        ),
